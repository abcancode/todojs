...
function addItem(){
 ...
 let todoItemPriorityValue = document.getElementById('todoPriority').value; //Get the value of the select box with id, todoPriority. Save the value inside variable called todoPriorityValue
 let todoItemDescription = document.getElementById("todoDesc").value; //Get the value of the textarea with id, todoDesc. Save the value inside variable called todoItemDescription 

 if(todoItemValue == '' || todoItemPriorityValue == '' || todoItemDescription == ''){
